...
export default function TriageMediumModal({ visible, onPrimaryPress, onSecondaryPress, reason }) {
    return (
        <CenteredModalCard
            visible={visible}
            title="Plan of Recovery – Step 1: 15-Min Discovery"
            subtitle="Let's ensure you're on the right track."
            footer={
                <>
                    <PrimaryButton
        ...
        >
            <View style={[styles.iconContainer, { backgroundColor: colors.bgMedium }]}>
                <MaterialCommunityIcons name="clipboard-check-outline" size={64} color={colors.warning} />
            </View>

            <View style={styles.infoContainer}>
                <BaseText style={styles.infoText}>
                    Based on your answers, a quick check-in could significantly improve your recovery outcome.
                </BaseText>
                {reason && (
