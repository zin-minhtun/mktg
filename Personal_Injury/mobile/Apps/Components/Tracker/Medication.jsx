...
export default function Medication() {
  ...
  return (
    <ScrollView style={{ backgroundColor: theme.background }} className="flex-1 px-3">
      <View className=" flex-row items-center justify-center my-8">
        ...
        <BaseText style={{ color: theme.textColor }} className=" text-center text-[16px]">
      ...
      <View className="  mt-4">
        <BaseText style={{ color: theme.textColor }} className=" text-lg font-bold mt-2">Select/Add Medication:</BaseText>
        ...
        >
          <View className=" flex-row gap-2 justify-center">
            ...
            <BaseText className=" text-[16px] text-white">Add Medication</BaseText>
          </View>
        </TouchableOpacity>
      </View>
      {medCards.map((card) => (
