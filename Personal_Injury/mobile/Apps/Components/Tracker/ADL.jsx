    ...
    <ScrollView className=" flex-1 px-3" style={{ backgroundColor: theme.background }}>
      ...
      <View className="mt-4 justify-center">
        <View className="justify-center items-center mt-4">
          <Text className="text-xl font-bold mb-4" style={{ color: theme.textColor }}>
        ...
        {categories.map((category, index) => (
          <List.Accordion
            ...
            style={{ backgroundColor: theme.textFieldBG, marginTop: 10 }}
          ...
          >
            {category.items.map((item, itemIndex) => (
              <List.Item
                key={itemIndex}
                title={<Text style={{ color: theme.textColor }}>{item.label}</Text>}
                description={item.description}
                descriptionStyle={{ color: theme.darkGrey }}
