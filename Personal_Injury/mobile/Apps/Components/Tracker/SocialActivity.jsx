...
export default function SocialActivity() {
  ...
  return (
    <ScrollView className="flex-1 px-3" style={{ backgroundColor: theme.background }}>
      ...
      <View className="mt-4">
        <Text className="text-lg" style={{ color: theme.textColor }}>Select Stimulation Level:</Text>
        ...
        >
          ...
          >
            <Picker.Item label="Low Stimulation" value="low" color={theme.mode === 'dark' ? '#fff' : '#000'} />
            <Picker.Item label="Moderate Stimulation" value="moderate" color={theme.mode === 'dark' ? '#fff' : '#000'} />
            <Picker.Item label="High Stimulation" value="high" color={theme.mode === 'dark' ? '#fff' : '#000'} />
          </Picker>
        </View>
      </View>

      <View className="mt-4">
        <Text className="text-lg" style={{ color: theme.textColor }}>Select Activity:</Text>
        <View className="border rounded overflow-hidden mt-1 mb-4"
          style={{
            borderColor: theme.borderColor || theme.textColor,
            backgroundColor: theme.textFieldBG
