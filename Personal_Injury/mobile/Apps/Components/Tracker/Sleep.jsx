...
export default function Sleep() {
  ...
  // Preset factor data - needs theme access for colors so moving inside or handling colors dynamically
  const getFactorIcons = (color) => ({
    Stress: {
      icon: <FontAwesome5 name="tired" size={24} color={color} />,
      factor: "Stress",
    },
    Caffeine: {
      icon: <MaterialCommunityIcons name="coffee" size={24} color={color} />,
      factor: "Caffeine",
    },
    Noise: {
      icon: <Entypo name="sound" size={24} color={color} />,
      factor: "Noise",
    },
    Exercise: {
      icon: <MaterialCommunityIcons name="run" size={24} color={color} />,
      factor: "Exercise",
    },
    Alcohol: {
      icon: <FontAwesome name="glass" size={24} color={color} />,
      factor: "Alcohol",
    },
    "Late meal": {
    ...
    "Screen time": {
      icon: <Entypo name="tv" size={24} color={color} />,
      factor: "Screen time",
    },
    "Room temperature": {
      icon: <Feather name="thermometer" size={24} color={color} />,
      factor: "Room temperature",
    },
    "Bed comfort": {
      icon: <MaterialCommunityIcons name="bed" size={24} color={color} />,
      factor: "Bed comfort",
    },
    "Partner disturbance": {
      icon: (
    ...
    "Kids disturbance": {
      icon: <MaterialCommunityIcons name="baby" size={24} color={color} />,
      factor: "Kids disturbance",
    },
    "Pet disturbance": {
      icon: <MaterialCommunityIcons name="dog" size={24} color={color} />,
    ...
    Travel: {
      icon: <MaterialCommunityIcons name="airplane" size={24} color={color} />,
      factor: "Travel",
    },
    Work: {
      icon: <MaterialCommunityIcons name="briefcase" size={24} color={color} />,
      factor: "Work",
    },
    Anxiety: {
      icon: (
    ...
    Allergies: {
      icon: <MaterialCommunityIcons name="flower" size={24} color={color} />,
      factor: "Allergies",
    },
    Illness: {
      icon: <MaterialCommunityIcons name="hospital" size={24} color={color} />,
      factor: "Illness",
    },
  });

  const factorIcons = getFactorIcons(theme.textColor);
  ...
  return (
    <ScrollView className="flex-1 px-3" style={{ backgroundColor: theme.background }}>
      ...
      <View className="p-3 rounded-lg mt-4" style={{ backgroundColor: theme.textFieldBG }}>
        {/* Display Total Sleep Time */}
        <View className="flex-row items-center justify-between">
          <View className=" flex-row items-center ">
            <Ionicons name="moon" size={24} color={theme.textColor} />
            <Text className="text-xl mt-4 mb-6 mx-2" style={{ color: theme.textColor }}>Total Sleep Time</Text>
          </View>
          <Text className="text-xl mt-4 mb-6 bg-green-300 p-2 rounded" style={{ color: '#000' }}>
            {calculateSleepHours()}
          </Text>
        </View>
        ...
        />
        {/* Sleep Quality */}
        <Text className="text-xl mt-4 mx-2 text-center" style={{ color: theme.textColor }}>
          Did you sleep well?
        </Text>
        ...
        <View className="flex-row items-center px-2 justify-between">
          <Text className="text-xl" style={{ color: theme.textColor }}>Factors</Text>
            ...
            {Object.keys(checkboxes).map((factor) => (
              <View key={factor} className=" flex-row items-center mt-2">
                ...
                <View className=" flex-row items-center ml-2">
                  ...
                  <Text className=" text-[16px] ml-2" style={{ color: theme.textColor }}>
        ...
        <View className=" mt-4">
          <View className=" flex-row gap-1 mb-2">
            <MaterialCommunityIcons name="bed" size={24} color={theme.textColor} />
            <Text className="text-xl" style={{ color: theme.textColor }}>Bed Time Hours</Text>
          </View>
          <View className=" flex-row justify-between mb-2">
            ...
            >
              <Text className="text-lg" style={{ color: '#000' }}>
        ...
        <View className=" justify-between flex-row mt-4">
          ...
          >
            <MaterialCommunityIcons name="timer" size={24} color={theme.textColor} />
          ...
          >
            <View className="flex-1 justify-center items-center " style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
              <View className="w-[80%] h-[150px] justify-center items-center p-4 rounded-xl"
                style={{ backgroundColor: theme.mode === 'dark' ? theme.textFieldBG : 'black' }}
              >
          ...
          <TouchableOpacity className=" items-center flex-row">
            <MaterialIcons name="sync" size={24} color={theme.textColor} />
