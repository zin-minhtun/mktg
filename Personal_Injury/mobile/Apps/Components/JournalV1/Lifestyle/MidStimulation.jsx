...
const MidStimulation = ({ prefill, editMode, selectedDate }) => {
    ...
    useEffect(() => {
        if (prefill) {
            setMidStimulationNote(prefill.notes || "");
    ...
    const handleCancel = () => { setMidStimulationNote(""); Keyboard.dismiss(); };

    const handleAccept = async () => {
        if (!midStimulationNote && selectedOptions.length === 0) {
                ...
                <View className="mt-8">
                    ...
                    <View className="flex-row justify-end mt-3">
                        ...
                        <TouchableOpacity
                            ...
                            style={{ backgroundColor: midStimulationNote.length > 0 ? "#FDA29B80" : (theme.mode === 'dark' ? '#003361' : '#E0E0E0') }}
                        >
                        ...
                        <TouchableOpacity
                            ...
                            style={{ backgroundColor: (midStimulationNote.length > 0 || selectedOptions.length > 0) && !loading ? "#22C55E" : (theme.mode === 'dark' ? '#003361' : '#E0E0E0') }}
                        >
                            {loading ? <ActivityIndicator size="small" color="#FFF" /> : <CheckIcon isActive={midStimulationNote.length > 0 || selectedOptions.length > 0} />}
                        </TouchableOpacity>
                    </View>
                </View>
